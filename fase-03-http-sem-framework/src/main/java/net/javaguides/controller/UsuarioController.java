...
import net.javaguides.http.Controller;
import net.javaguides.http.HttpMethod;
import net.javaguides.http.HttpRequest;
import net.javaguides.http.HttpResponse;
...
public final class UsuarioController implements Controller {
    ...
    private HttpResponse handlePost(HttpRequest request){
       try{
            ...
            var input = new CadastrarUsuarioInput(nome,email,idade);
       ...
       } catch (net.javaguides.dominio.UsuarioJaExisteException e) {
    ...
    private HttpResponse handleGet(HttpRequest request){
        try{
            ...
            var input = new BuscarPorEmailInput(email);
